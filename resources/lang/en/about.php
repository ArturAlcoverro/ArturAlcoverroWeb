...
return [
    ...
    "experience-1-2" => " Telematel",

    "skills-title" => "Skills",
    "skills-1-1" => "Programming language:",
    "skills-1-2" => " C, C#, Java, Bash, JavaScript, PHP, Progress ABL, C++ (Arduino).",
    "skills-2-1" => "Frameworks:",
    "skills-2-2" => " Laravel, Android Studio, Arduino.",
    "skills-3-1" => "Web libraries:",
    "skills-3-2" => " Bootstrap, Jquery, Datatables.",
    "skills-4-1" => "Databases:",
    "skills-4-2" => " SQL, MongoDB.",
    "skills-5-1" => "Other Languages:",
    "skills-5-2" => " JSON, XML, HTML, CSS, SASS, XSLT.",
